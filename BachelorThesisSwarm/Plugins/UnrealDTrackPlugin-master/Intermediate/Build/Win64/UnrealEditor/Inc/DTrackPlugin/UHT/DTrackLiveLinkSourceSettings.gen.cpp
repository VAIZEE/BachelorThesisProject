...
template<> DTRACKPLUGIN_API UScriptStruct* StaticStruct<FDTrackServerSettings>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_m_dtrack_start_mea_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_m_dtrack_tactile_fingers_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_m_coordinate_system_MetaData[];
#endif
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_server_port = { "m_dtrack_server_port", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDTrackServerSettings, m_dtrack_server_port), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_server_port_MetaData), Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_server_port_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_start_mea_MetaData[] = {
		{ "Category", "Server Settings" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_start_mea = { "m_dtrack_start_mea", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDTrackServerSettings), &Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_start_mea_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_start_mea_MetaData), Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_start_mea_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_dtrack_tactile_fingers_MetaData[] = {
		{ "Category", "Server Settings" },
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewProp_m_coordinate_system_MetaData[] = {
		{ "Category", "Server Settings" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDTrackLiveLinkSourceSettings_Statics::NewProp_m_server_settings = { "m_server_settings", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDTrackLiveLinkSourceSettings, m_server_settings), Z_Construct_UScriptStruct_FDTrackServerSettings, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UDTrackLiveLinkSourceSettings_Statics::NewProp_m_server_settings_MetaData), Z_Construct_UClass_UDTrackLiveLinkSourceSettings_Statics::NewProp_m_server_settings_MetaData) }; // 2820025531
	...
	UDTrackLiveLinkSourceSettings::UDTrackLiveLinkSourceSettings(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UDTrackLiveLinkSourceSettings);
	UDTrackLiveLinkSourceSettings::~UDTrackLiveLinkSourceSettings() {}
	struct Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics::ScriptStructInfo[] = {
		{ FDTrackServerSettings::StaticStruct, Z_Construct_UScriptStruct_FDTrackServerSettings_Statics::NewStructOps, TEXT("DTrackServerSettings"), &Z_Registration_Info_UScriptStruct_DTrackServerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDTrackServerSettings), 2820025531U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDTrackLiveLinkSourceSettings, UDTrackLiveLinkSourceSettings::StaticClass, TEXT("UDTrackLiveLinkSourceSettings"), &Z_Registration_Info_UClass_UDTrackLiveLinkSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDTrackLiveLinkSourceSettings), 2396518662U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_538979795(TEXT("/Script/DTrackPlugin"),
		Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHub_UE5_FHWedelCAVETemplate_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkSourceSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
