...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDTrackFlystickInputRole_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDTrackFlystickInputRole_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDTrackFlystickInputRole_Statics::Class_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDTrackHandRole_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDTrackHandRole_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDTrackHandRole_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkRole_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkRole_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDTrackFlystickInputRole, UDTrackFlystickInputRole::StaticClass, TEXT("UDTrackFlystickInputRole"), &Z_Registration_Info_UClass_UDTrackFlystickInputRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDTrackFlystickInputRole), 729949903U) },
		{ Z_Construct_UClass_UDTrackHandRole, UDTrackHandRole::StaticClass, TEXT("UDTrackHandRole"), &Z_Registration_Info_UClass_UDTrackHandRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDTrackHandRole), 2794321260U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkRole_h_2727820326(TEXT("/Script/DTrackPlugin"),
		Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkRole_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Public_DTrackLiveLinkRole_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
