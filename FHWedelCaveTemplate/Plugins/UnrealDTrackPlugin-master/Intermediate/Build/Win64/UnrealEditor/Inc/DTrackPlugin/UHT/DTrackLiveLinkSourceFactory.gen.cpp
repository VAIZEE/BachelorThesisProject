...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDTrackLiveLinkSourceFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDTrackLiveLinkSourceFactory_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDTrackLiveLinkSourceFactory_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Private_DTrackLiveLinkSourceFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Private_DTrackLiveLinkSourceFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDTrackLiveLinkSourceFactory, UDTrackLiveLinkSourceFactory::StaticClass, TEXT("UDTrackLiveLinkSourceFactory"), &Z_Registration_Info_UClass_UDTrackLiveLinkSourceFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDTrackLiveLinkSourceFactory), 2569337458U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Private_DTrackLiveLinkSourceFactory_h_3806757158(TEXT("/Script/DTrackPlugin"),
		Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Private_DTrackLiveLinkSourceFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_flara_OneDrive_Dokumente_GitHubProjects_BachelorThesisProject_FHWedelCaveTemplate_Plugins_UnrealDTrackPlugin_master_Source_DTrackPlugin_Private_DTrackLiveLinkSourceFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
